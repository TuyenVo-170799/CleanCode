...
<body>
	<header>
		...
		<div class="p-5 text-center bg-light" style="margin-top: 58px;">
			<h1 class="mb-3">Form Edit Category</h1>
		</div>
		<!-- Jumbotron -->
	</header>
    ...
    <main class="my-4">
        <div class="container">
            <form action="/test/admin-category/edit" method="post">
            	<div class="form-group mb-2"> 
					<input type="hidden" class="form-control" name="id" value='<c:out value="${category.id }" />'>
				</div>
				<div class="form-group mb-2">
					<label class="form-check-label">Id</label> 
					<input type="text" class="form-control" value='<c:out value="${category.id }" />' disabled="disabled">
				</div>
                <div class="form-group mb-2">
                    <label class="form-check-label">Name</label>
                    <input type="text" class="form-control" name="categoryName" placeholder="Category Name" required="required" value='<c:out value="${category.categoryName }"/>'>
                </div>
                <div class="form-group mb-2">
                    <label class="form-check-label">Code</label>
                    <input type="text" class="form-control" name="categoryCode" placeholder="Category Code" required="required" value='<c:out value="${category.categoryCode }"/>'>
                </div>
                <div>
