...
<body>
	...
	<header class="masthead"
		style="background-image: url('${pageContext.request.contextPath}/template/web/img/${post.id}/${post.thumbnail }')">
			...
			<div class="row">
				<div class="col-lg-8 col-md-10 mx-auto">
					<div class="post-heading">
						...
						<span class="meta">Posted by <a href="#">${post.createdBy }</a> on ${post.createdDate }</span>
					</div>
				</div>
			</div>
		</div>
